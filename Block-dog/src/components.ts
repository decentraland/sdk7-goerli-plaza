...
export const MoveTransformComponent = engine.defineComponent("MoveTransform", MoveTransformSchema)
...
export const NPCComponent = engine.defineComponent("NPC", NPCSchema)
...
export const TimeOutComponent = engine.defineComponent("TimeOut", TimeOutSchema)
