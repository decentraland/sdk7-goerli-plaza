...
export class UIPopupAnimation {  
  ...
  constructor(startEndTransform:StartEndTransform, duration:number, onClick:Callback){
    ...
    this.animator.addAnimationSequence(
      ...
      .then(new MoveScaleAction(this.animator.entity, this.transform.endPosX, this.transform.endPosY, this.transform.endScaleX, this.transform.endScaleY,  duration,  utils.InterpolationType.EASEOUTQUAD)) 
    )
    ...
    this.animator.addAnimationSequence(
      ...
      //.then(new MoveScaleAction(this.animator.entity, this.transform.endPosX, this.transform.endPosY, this.transform.endScaleX, this.transform.startScaleY,  0.2,  utils.InterpolationType.EASEOUTQUAD))
      .then(new MoveScaleAction(this.animator.entity, this.transform.startPosX, this.transform.startPosY, this.transform.startScaleX, this.transform.startScaleY, duration,  utils.InterpolationType.EASEOUTQUAD))    
    )
