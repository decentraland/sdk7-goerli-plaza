...
import { isCampaignEarly, isCampaignLate } from '../claim'
        ...
        >
            ...
            >
                ...
                <UiEntity key={"ui-error"}
                    uiTransform={{
                        display: (activeUiType === UiType.ERROR) ? 'flex' : 'none',
...
function addButtonESystem(){
    ...
    engine.addSystem(() => {
        if(activeUiType !== UiType.SUCCESS && activeUiType !== UiType.CAMPAIGN_NOT_STARTED && activeUiType !== UiType.CAMPAIGN_ENDED) return
