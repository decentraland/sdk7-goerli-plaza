...
const projectPath = "land-flipper"
const description = "This scene uses P2P to sync changes between all players. Each player has their own color, tiles change color when stepping on them."
const Max_Chars = 45
