...
export const artPositions: ArtPostions[] = [
    ...
    { position: Vector3.create(2.8, 3.25, 16), rotation: Vector3.create(0, -90, 0), scale: Vector3.create(0.003 * 1920, 0.003 * 1080, 1) }, // 1
    { position: Vector3.create(2.82, 3, 22.19), rotation: Vector3.create(0, -90, 0), scale: Vector3.create(4, 4, 4) }, // 2
    // South door
    { position: Vector3.create(12.15, 3, 7.75), rotation: Vector3.create(0, 180, 0), scale: Vector3.create(1.5, 1.5, 1.5) }, // 3
    // North door
    ...
    { position: Vector3.create(3.5, 15.43, 12), rotation: Vector3.create(0, -90, 0), scale: Vector3.create(0.0025 * 1920, 0.0025 * 1080, 1) }, // 13
    { position: Vector3.create(3.5, 15.43, 20.15), rotation: Vector3.create(0, -90, 0), scale: Vector3.create(0.0025 * 1920, 0.0025 * 1080, 1) }, // 14
    ...
    { position: Vector3.create(21.75, 13.25, 24.5), rotation: Vector3.create(0, 180, 0), scale: Vector3.create(6, 8.65, 1) }, // 25
