...
const verticalVideo =
  'https://player.vimeo.com/external/931742718.m3u8?s=efbe1b55804e4ba10b2e8c17e241d1809d324f36&logging=false'
const verticalVideoPlaceholder =
  'https://bafkreicuvnybcylixwtpxslw4cvwmtwg566z2d6cinxshqbg25lhojkqtq.ipfs.nftstorage.link/'

const verticalVarbarianVid =
  'https://player.vimeo.com/external/931794663.m3u8?s=3a78fb41c8f6e7f39962465441abecbe7a056262&logging=false'
const verticalVarbarianPlaceholder =
  'https://bafkreibuzswvpnmmvux3b6vfwfeggbmakubxwdztrqmqerjjm7ba6efcpu.ipfs.nftstorage.link/'

const horizontalVideoMVFW23 =
  'https://player.vimeo.com/external/931744777.m3u8?s=2a274c3898d4aa78fdb7cddf0a0329d25693b056&logging=false'
const horizontalVideoMVFW23placeholder =
  'https://bafybeigpiynyk563o5rd4wzz62lx7gkncdrnozhzit4l7s4maxc5mffgbm.ipfs.nftstorage.link/'

const horizontalVideoLPMxSOA =
  'https://player.vimeo.com/external/711197011.m3u8?s=1fe29a85f3c1455580a070eee4fb93abcb2ed5a2&logging=false'
const horizontalVideoLPMxSOAplaceholder =
  'https://bafkreigpeshmzddtlhw5tpxa55z3lfv7yjyzpkoj3s7vc5wxyuy367o5ji.ipfs.nftstorage.link/'

const horizontalVideoIndieVillage =
  'https://player.vimeo.com/external/931792879.m3u8?s=fa7ece24dfd2899ddac2112250092c4be5dbdff0&logging=false'
const horizontalVideoIndieVillagePlaceholder =
  'https://bafkreie2rucyrbnl5en7bccthydcxsmddhffp4oincu7afc2jt53u4eb6e.ipfs.nftstorage.link/'
...
export const videoCollection: VideoData[] = [
  {
    ...
    triggerPosition: Vector3.create(
      artPositions[1].position.x + 2,
      artPositions[1].position.y - 1,
      artPositions[1].position.z
    ),
    audio: true,
    hasAlpha: false
  },
  {
    ...
    triggerPosition: Vector3.create(
      artPositions[13].position.x + 2,
      artPositions[13].position.y - 1,
      artPositions[13].position.z
    ),
    audio: true,
    hasAlpha: false
  },
  {
    ...
    triggerScale: Vector3.create(4, 2, 4),
    triggerPosition: Vector3.create(
      artPositions[14].position.x + 2,
      artPositions[14].position.y - 1,
      artPositions[14].position.z
    ),
    audio: true,
    hasAlpha: false
  },
  {
    ...
    triggerPosition: Vector3.create(
      artPositions[24].position.x,
      artPositions[24].position.y - 1,
      artPositions[24].position.z - 2
    ),
    audio: false,
    hasAlpha: false
  },
  {
    ...
    triggerScale: Vector3.create(8, 6, 6),
    triggerPosition: Vector3.create(
      artPositions[25].position.x,
      artPositions[25].position.y - 1,
      artPositions[25].position.z + 4
    ),
    audio: true,
    hasAlpha: false
  }
