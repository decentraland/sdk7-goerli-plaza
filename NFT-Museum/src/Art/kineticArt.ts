...
export const kineticArtCollection: KineticData[] = [
  {
    ...
    position: Vector3.create(
      artPositions[26].position.x,
      artPositions[26].position.y - 0.58,
      artPositions[26].position.z + 0.1
    ),
    rotation: Quaternion.fromEulerDegrees(
      artPositions[26].rotation.x,
      artPositions[26].rotation.y,
      artPositions[26].rotation.z
    ),
  ...
  },
  {
    ...
    id: 27,
    position: Vector3.create(
      artPositions[27].position.x,
      artPositions[27].position.y - 0.58,
      artPositions[27].position.z - 0.1
    ),
    rotation: Quaternion.fromEulerDegrees(
      artPositions[27].rotation.x,
      artPositions[27].rotation.y,
      artPositions[27].rotation.z
    ),
  ...
  },
  {
    ...
    rotation: Quaternion.fromEulerDegrees(
      artPositions[28].rotation.x,
      artPositions[28].rotation.y,
      artPositions[28].rotation.z
    ),
  ...
  },
  {
    ...
    rotation: Quaternion.fromEulerDegrees(
      artPositions[29].rotation.x,
      artPositions[29].rotation.y,
      artPositions[29].rotation.z
    ), // rotation
