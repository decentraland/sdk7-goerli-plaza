...
export function createCustomTextPanels() {
  createText(Vector3.create(8.99, 3.3, 4.66), Vector3.create(0, 0, 0), textPanelValue, serif, 1, textPanelColor, 15)

  createText(Vector3.create(8.99, 3.3, 27.35), Vector3.create(0, 180, 0), textPanelValue, serif, 1, textPanelColor, 15)
...
export function createCustomTextTitles() {
  if (showCustomText) {
    createText(Vector3.create(14.25, 5.85, 16), Vector3.create(0, -90, 0), artGalleryText, mono, 8, artGalleryColor, 40)

    createText(Vector3.create(26.7, 5.85, 16), Vector3.create(0, 90, 0), elevatorText, mono, 8, elevatorFontColor, 40)
