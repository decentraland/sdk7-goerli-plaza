...
export function exampleLabelsUI() {
    ...
    return (
        ...
        >
            ...
            <UiEntity uiText={{ value: "Button Animations", fontSize: lableFontSize, textAlign: 'middle-center' }} uiTransform={{ positionType: 'absolute', width: '5%', height: "3%", position: { top: '3%', left: '57.5%' } }} />
            <UiEntity uiText={{ value: "Animated Popup", fontSize: lableFontSize, textAlign: 'middle-center' }} uiTransform={{ positionType: 'absolute', width: '5%', height: "3%", position: { top: '3%', left: '72.5%' } }} />
