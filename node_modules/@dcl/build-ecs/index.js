...
function watchFile(fileName, services, files, cfg) {
    if (!watchedFiles.has(fileName)) {
        ...
        ts.sys.watchFile(fileName, (fileName, _type) => {
...
function emitFile(fileName, services, cfg) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        function loadDclLib(lib) {
            const path = findLibraryEntryPoint(lib, ts.sys.getCurrentDirectory()) ||
                resolveFile(lib);
            if (path) {
        ...
        function loadLibOrJs(lib) {
            if (PRODUCTION) {
                ...
                return (
                /*loadDclLib(lib + '.lib') ||*/ loadJsLib(lib.replace(/\.js$/, '.min.js')) ||
                    loadJsLib(lib) ||
                    false);
            }
            else {
        ...
        for (const [, file] of out) {
            if (file.path.endsWith('.js') &&
                ...
                if (PRODUCTION || cfg.isDecentralandLib) {
                    // minify && source map
                    const minifiedFile = getOutFile(cfg.isDecentralandLib
