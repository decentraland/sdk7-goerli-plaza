import { engine, Entity, InputAction, Transform, GltfContainer, AudioSource, pointerEventsSystem, MeshCollider, ColliderLayer } from '@dcl/sdk/ecs'
...
export function main() {
	...
	GltfContainer.create(puffer, {
		src: 'models/puffer.gltf', visibleMeshesCollisionMask: ColliderLayer.CL_POINTER,
