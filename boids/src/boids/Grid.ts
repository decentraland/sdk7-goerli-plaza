...
export default class Grid {
   ...
   * @param {Object} entity 
   */
  removeEntity(entity: BoidEntity) {
    const index = this.getGridIndex(entity.x, entity.y, entity.z) | 0;
   ...
   */
  moveEntity(entity: BoidEntity, newX: number, newY: number, newZ: number) {
   ...
   */
  getEntitiesInCube(originX: number, originY: number, originZ: number, size: number, callback: (e: BoidEntity) => void) {
