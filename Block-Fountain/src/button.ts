import { engine, Animator, Transform, Entity, GltfContainer, AudioSource, CameraType, QuaternionType } from '@dcl/sdk/ecs';
...
export class Button {
    ...
    constructor(
        ...
        const eulerRotationButton = Quaternion.fromEulerDegrees(
            rotation.x,
            rotation.y,
            rotation.z
        );
        ...
        this.buttonClickComponent = new ButtonClickComponent(
            animationName,
            audioClipUrl
        );
...
export class Switch {
    ...
    constructor(
        ...
        const eulerRotationSwitch = Quaternion.fromEulerDegrees(
            rotation.x,
            rotation.y,
            rotation.z
        );
        ...
        this.animator = Animator.createOrReplace(this.switchEntity, {
            states:[{
                name: onAnim,
                clip: onAnim,
                playing: false,
    ...
    public toggle(value: boolean): void {
        ...
        this.animator.getClip(this.switchEntity, animationClipName).stop();

        // Play the selected animation
        this.animator.getClip(this.switchEntity, animationClipName).play();
