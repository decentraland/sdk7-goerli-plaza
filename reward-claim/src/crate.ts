...
import { AudioSource, engine, Entity, GltfContainer, InputAction, PointerEvents, pointerEventsSystem, raycastSystem, Schemas, Transform } from '@dcl/sdk/ecs'
...
export function DropCrate(crate: Entity, parachute: Entity, speed?: number) {
  ...
  raycastSystem.registerLocalDirectionRaycast(
    ...
    function (raycastResult) {
      ...
      if (raycastResult.hits[0].position) {
