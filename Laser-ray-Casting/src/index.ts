...
import { boxesCount, defaultMaterial, inmuneMaterial, MovingCube, rayDistance, rayMaterial, RayMesh } from './definitions'
...
engine.addSystem((deltaTime) => {
	...
	if ((rotationSpeed < 0 && yRotation < 336 && yRotation > 300)
		|| (rotationSpeed > 0 && yRotation > 24 && yRotation < 300))
		rotationSpeed *= -1
})

// Ray mesh
export const rayMeshEntity = engine.addEntity()
